...
-- ----------------------------
-- Table structure for CG_CREDIT_LIST
-- ----------------------------
...
CREATE TABLE `CG_CREDIT_LIST`  (
  ...
  `F_MDLB` varchar(2) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '名单类别：4:重点关注名单;8:失信黑名单;2:守信红名单',
  ...
  `F_FRDB` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '法人代表/企业法人姓名',
  `F_LRYY` blob NULL COMMENT '列入名单原因/法律生效文书确定的义务/失信行为情况',
  ...
  `F_LRBM` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '列入部门/信息报送机关',
  `F_BZ` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '备注',
  `F_RKSJ` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '入库时间',
  `F_ZXYJWH` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '执行依据文号',
  ...
  `F_FBSJ` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '发布时间/设立日期/列入日期',
  ...
  `F_BZXRMC` varchar(500) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '被执行人名称/主要负责人',
  ...
  `F_NRLY` varchar(500) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '纳入理由',
  `F_MDMC` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '名单名称',
