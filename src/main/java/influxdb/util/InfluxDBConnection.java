...
public class InfluxDBConnection {
	...
	private static final Logger logger = LoggerFactory.getLogger(influxdb.util.InfluxDBConnection.class);
	 ...
	 * @throws Exception
	 */
	public InfluxDB influxDbBuild() throws Exception {
		influxDB = InfluxDBFactory.connect(openurl, username, password);
		Pong pong = influxDB.ping();
		if (pong != null) {
			logger.info("pong：" + pong + ",连接成功！");
		} else {
			throw new Exception("未获取到influxdb连接");
		}
		return influxDB;
	}
